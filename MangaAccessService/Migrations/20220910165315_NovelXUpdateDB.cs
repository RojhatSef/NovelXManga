...
{
    public partial class NovelXUpdateDB : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    GroupScanlatingID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    GroupScanlatingName = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_studioModels", x => x.StudioId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_chapterModels_groupScanlatingModels_chapterID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudioModelID = table.Column<int>(type: "int", nullable: false),
                    GroupsSanlatingId = table.Column<int>(type: "int", nullable: false),
                    ChapterModelId = table.Column<int>(type: "int", nullable: false),
                    AuthorModelID = table.Column<int>(type: "int", nullable: false),
                    ArtistModelID = table.Column<int>(type: "int", nullable: false),
                    MangaModelId = table.Column<int>(type: "int", nullable: false),
                    MasterID = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MasterModels", x => new { x.MangaModelId, x.GroupsSanlatingId, x.postModelID, x.ChapterModelId, x.ArtistModelID, x.AuthorModelID, x.StudioModelID });
                    table.ForeignKey(
                        name: "FK_MasterModels_artistModels_MangaModelId",
                        column: x => x.MangaModelId,
                        principalTable: "artistModels",
                        principalColumn: "ArtistId");
                    table.ForeignKey(
                        name: "FK_MasterModels_authorModels_MangaModelId",
                        column: x => x.MangaModelId,
                        principalTable: "authorModels",
                        principalColumn: "AuthorId");
                    table.ForeignKey(
                        name: "FK_MasterModels_chapterModels_MangaModelId",
                        column: x => x.MangaModelId,
                        principalTable: "chapterModels",
                        principalColumn: "chapterID");
                    table.ForeignKey(
                        name: "FK_MasterModels_groupScanlatingModels_MangaModelId",
                        column: x => x.MangaModelId,
                        principalTable: "groupScanlatingModels",
                        principalColumn: "GroupScanlatingID");
                    table.ForeignKey(
                        name: "FK_MasterModels_mangaModels_MangaModelId",
                        column: x => x.MangaModelId,
                        principalTable: "mangaModels",
                        principalColumn: "MangaID");
                    table.ForeignKey(
                        name: "FK_MasterModels_Posts_MangaModelId",
                        column: x => x.MangaModelId,
                        principalTable: "Posts",
                        principalColumn: "PostId");
                    table.ForeignKey(
                        name: "FK_MasterModels_studioModels_MangaModelId",
                        column: x => x.MangaModelId,
                        principalTable: "studioModels",
