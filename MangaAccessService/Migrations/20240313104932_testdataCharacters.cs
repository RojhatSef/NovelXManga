...
{
    public partial class testdataCharacters : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CompletedBookListID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CompletedList = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MangaModelId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DroppedId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DroppedNameList = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MangaModelId = table.Column<int>(type: "int", nullable: true),
                    UserId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    isChecked = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FavoritBookListId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    FavoritNameList = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MangaModelId = table.Column<int>(type: "int", nullable: true),
                    UserId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    isChecked = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NextAllowedPostTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsChecked = table.Column<bool>(type: "bit", nullable: false),
                    UserID = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ReadId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ReadingListName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MangaModelId = table.Column<int>(type: "int", nullable: true),
                    UserId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsChecked = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    WishBookListId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    WishNameList = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MangaModelId = table.Column<int>(type: "int", nullable: true),
                    UserId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsChecked = table.Column<bool>(type: "bit", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserSettings", x => x.UserModelId);
                    table.ForeignKey(
                        name: "FK_UserSettings_AspNetUsers_UserModelId",
                        column: x => x.UserModelId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "ArtistModelCharacter",
                columns: table => new
                {
                    ArtistModelArtistId = table.Column<int>(type: "int", nullable: false),
                    CreatorsCharactersCharacterId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArtistModelCharacter", x => new { x.ArtistModelArtistId, x.CreatorsCharactersCharacterId });
                    table.ForeignKey(
                        name: "FK_ArtistModelCharacter_artistModels_ArtistModelArtistId",
                        column: x => x.ArtistModelArtistId,
                        principalTable: "artistModels",
                        principalColumn: "ArtistId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ArtistModelCharacter_Characters_CreatorsCharactersCharacterId",
                        column: x => x.CreatorsCharactersCharacterId,
            ...
            migrationBuilder.CreateTable(
                name: "AuthorModelCharacter",
                columns: table => new
                {
                    CharacterAuthorAuthorID = table.Column<int>(type: "int", nullable: false),
                    CreatorsCharactersCharacterId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AuthorModelCharacter", x => new { x.CharacterAuthorAuthorID, x.CreatorsCharactersCharacterId });
                    table.ForeignKey(
                        name: "FK_AuthorModelCharacter_authorModels_CharacterAuthorAuthorID",
                        column: x => x.CharacterAuthorAuthorID,
                        principalTable: "authorModels",
                        principalColumn: "AuthorID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AuthorModelCharacter_Characters_CreatorsCharactersCharacterId",
                        column: x => x.CreatorsCharactersCharacterId,
                        principalTable: "Characters",
                        principalColumn: "CharacterId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CharacterVoiceActorModel", x => new { x.CreatorsCharactersCharacterId, x.VoiceActorsVoiceActorId });
                    table.ForeignKey(
                        name: "FK_CharacterVoiceActorModel_Characters_CreatorsCharactersCharacterId",
                        column: x => x.CreatorsCharactersCharacterId,
                        principalTable: "Characters",
                        principalColumn: "CharacterId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CharacterVoiceActorModel_voiceActorModels_VoiceActorsVoiceActorId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MangaID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MangaName = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    ISBN10 = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    ISBN13 = table.Column<string>(type: "nvarchar(14)", maxLength: 14, nullable: true),
                    futureEvents = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    StatusInCountryOfOrigin = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    CompletelyTranslated = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    orignalWebtoon = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    OriginalPublisher = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    Rank = table.Column<int>(type: "int", nullable: true),
                    PageView = table.Column<int>(type: "int", nullable: true),
                    Type = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    OfficalLanguage = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    PhotoPath = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LastDailyReadDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastWeeklyReadDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastMonthlyReadDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastYearlyReadDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DailyRead = table.Column<int>(type: "int", nullable: true),
                    ...
                    ForeverRead = table.Column<int>(type: "int", nullable: true),
                    ...
                    BookUpdated = table.Column<DateTime>(type: "datetime2", nullable: true),
                    BlogModelId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrivateConversationId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PrivateMessages_PrivateConversations_PrivateConversationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Attachments_PrivateMessages_PrivateMessageId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PrivateMessageReports", x => x.ReportId);
                    table.ForeignKey(
                        name: "FK_PrivateMessageReports_AspNetUsers_ReportedById",
                        column: x => x.ReportedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PrivateMessageReports_PrivateMessages_PrivateMessageId",
                        column: x => x.PrivateMessageId,
                        principalTable: "PrivateMessages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AssociatedNamesId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    nameString = table.Column<string>(type: "nvarchar(1500)", maxLength: 1500, nullable: false),
                    MangaID = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReportAssignments", x => x.AssignmentId);
                    table.ForeignKey(
                        name: "FK_ReportAssignments_AspNetUsers_AdminId",
                        column: x => x.AdminId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ReportAssignments_PrivateMessageReports_ReportId",
                        column: x => x.ReportId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Languages__UserSettings_UserSettingsUserModelId",
            ...
            migrationBuilder.CreateTable(
                name: "ReportUpdateLogs",
                columns: table => new
                {
                    LogId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ReportAssignmentId = table.Column<int>(type: "int", nullable: false),
                    UpdatedByAdminId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReportUpdateLogs", x => x.LogId);
                    table.ForeignKey(
                        name: "FK_ReportUpdateLogs_AspNetUsers_UpdatedByAdminId",
                        column: x => x.UpdatedByAdminId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReportUpdateLogs_ReportAssignments_ReportAssignmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArtistModelCharacter_CreatorsCharactersCharacterId",
                table: "ArtistModelCharacter",
                column: "CreatorsCharactersCharacterId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attachments_PrivateMessageId",
                table: "Attachments",
                column: "PrivateMessageId");

            migrationBuilder.CreateIndex(
                name: "IX_AuthorModelCharacter_CreatorsCharactersCharacterId",
                table: "AuthorModelCharacter",
                column: "CreatorsCharactersCharacterId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CharacterVoiceActorModel_VoiceActorsVoiceActorId",
                table: "CharacterVoiceActorModel",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Languages__UserSettingsUserModelId",
                table: "Languages_",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PrivateMessageReports_PrivateMessageId",
                table: "PrivateMessageReports",
                column: "PrivateMessageId");

            migrationBuilder.CreateIndex(
                name: "IX_PrivateMessageReports_ReportedById",
                table: "PrivateMessageReports",
                column: "ReportedById");

            migrationBuilder.CreateIndex(
                name: "IX_PrivateMessages_PrivateConversationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReportAssignments_AdminId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReportUpdateLogs_ReportAssignmentId",
                table: "ReportUpdateLogs",
                column: "ReportAssignmentId");

            migrationBuilder.CreateIndex(
                name: "IX_ReportUpdateLogs_UpdatedByAdminId",
                table: "ReportUpdateLogs",
