...
namespace MangaAccessService.Migrations
{
    ...
    [Migration("20240313104932_testdataCharacters")]
    partial class testdataCharacters
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ArtistModelCharacter", b =>
                {
                    b.Property<int>("ArtistModelArtistId")
                        .HasColumnType("int");

                    b.Property<int>("CreatorsCharactersCharacterId")
                        .HasColumnType("int");

                    b.HasKey("ArtistModelArtistId", "CreatorsCharactersCharacterId");

                    b.HasIndex("CreatorsCharactersCharacterId");

                    b.ToTable("ArtistModelCharacter");
                });
            ...
            modelBuilder.Entity("AuthorModelCharacter", b =>
                {
                    b.Property<int>("CharacterAuthorAuthorID")
                        .HasColumnType("int");

                    b.Property<int>("CreatorsCharactersCharacterId")
                        .HasColumnType("int");

                    b.HasKey("CharacterAuthorAuthorID", "CreatorsCharactersCharacterId");

                    b.HasIndex("CreatorsCharactersCharacterId");

                    b.ToTable("AuthorModelCharacter");
                });
            ...
            modelBuilder.Entity("CharacterVoiceActorModel", b =>
                {
                    b.Property<int>("CreatorsCharactersCharacterId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("CreatorsCharactersCharacterId", "VoiceActorsVoiceActorId");

                    b.HasIndex("VoiceActorsVoiceActorId");

                    b.ToTable("CharacterVoiceActorModel");
                });
            ...
            modelBuilder.Entity("MangaModelService.Attachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MangaModelService.CompletedBookList", b =>
                {
                    ...
                    b.Property<string>("CompletedList")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("MangaModelService.DroppedBookList", b =>
                {
                    ...
                    b.Property<string>("DroppedNameList")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("MangaModelService.FavoritBookList", b =>
                {
                    ...
                    b.Property<string>("FavoritNameList")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("MangaModelService.MangaModel", b =>
                {
                    ...
                    b.Property<DateTime?>("BookUpdated")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("MangaModelService.PrivateConversation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MangaModelService.PrivateMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MangaModelService.PrivateMessageReport", b =>
                {
                    ...
                    b.ToTable("PrivateMessageReports");
                });
            ...
            modelBuilder.Entity("MangaModelService.ReportAssignment", b =>
                {
            ...
            modelBuilder.Entity("MangaModelService.ReportUpdateLog", b =>
                {
            ...
            modelBuilder.Entity("MangaModelService.WishBookList", b =>
                {
                    ...
                    b.Property<string>("WishNameList")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ArtistModelCharacter", b =>
                {
                    b.HasOne("MangaModelService.ArtistModel", null)
                        .WithMany()
                        .HasForeignKey("ArtistModelArtistId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MangaModelService.Character", null)
                        .WithMany()
                        .HasForeignKey("CreatorsCharactersCharacterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("AuthorModelCharacter", b =>
                {
                    b.HasOne("MangaModelService.AuthorModel", null)
                        .WithMany()
                        .HasForeignKey("CharacterAuthorAuthorID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MangaModelService.Attachment", b =>
                {
                    b.HasOne("MangaModelService.PrivateMessage", "PrivateMessage")
            ...
            modelBuilder.Entity("MangaModelService.PrivateConversation", b =>
                {
                    b.HasOne("MangaModelService.UserModel", "UserOne")
                        .WithMany("ConversationsAsUserOne")
                        .HasForeignKey("UserOneId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("MangaModelService.UserModel", "UserTwo")
            ...
            modelBuilder.Entity("MangaModelService.PrivateMessage", b =>
                {
                    b.HasOne("MangaModelService.PrivateConversation", null)
                        .WithMany("PrivateMessages")
                        .HasForeignKey("PrivateConversationId");

                    b.HasOne("MangaModelService.UserModel", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("MangaModelService.UserModel", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("MangaModelService.PrivateMessageReport", b =>
                {
                    b.HasOne("MangaModelService.PrivateMessage", "PrivateMessage")
                        .WithMany("PrivateMessageReports")
                        .HasForeignKey("PrivateMessageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MangaModelService.UserModel", "ReportedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("MangaModelService.ReportAssignment", b =>
                {
                    b.HasOne("MangaModelService.UserModel", "Admin")
                        .WithMany()
                        .HasForeignKey("AdminId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("MangaModelService.PrivateMessageReport", "Report")
            ...
            modelBuilder.Entity("MangaModelService.ReportUpdateLog", b =>
                {
                    b.HasOne("MangaModelService.ReportAssignment", "ReportAssignment")
                        .WithMany("UpdateLogs")
                        .HasForeignKey("ReportAssignmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MangaModelService.UserModel", "UpdatedByAdmin")
                        .WithMany()
            ...
            modelBuilder.Entity("MangaModelService.UserBlock", b =>
                {
                    ...
                    b.HasOne("MangaModelService.UserModel", "Blocker")
            ...
            modelBuilder.Entity("MangaModelService.UserSettings", b =>
                {
                    b.HasOne("MangaModelService.UserModel", "UserModel")
                        ...
                        .HasForeignKey("MangaModelService.UserSettings", "UserModelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MangaModelService.PrivateMessage", b =>
                {
                    ...
                    b.Navigation("PrivateMessageReports");
                });
