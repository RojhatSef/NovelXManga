    ...
    public class SeedData
    {
        ...
        public async Task seedData()
        {
            ...
            if (!context.mangaModels.Any())
            {
                ...
                {
                new Languages { LanguageName = "English" },
                new Languages { LanguageName = "Japanese" },
                new Languages { LanguageName = "German" },
                },

                    OfficalWebsites = new List<OfficalWebsite>
                {
                new OfficalWebsite { OfficalWebsiteString = "www.fullmetalAlchemist.com", WebsiteName = "FullmetalAlchemist.Com"},
                new OfficalWebsite { OfficalWebsiteString = "fullMetalAlchemist.jp", WebsiteName = "FullmetalAlchemist.jp" },
                },
              ...
              tag4, tag5, tag6
                ...
                MangaModel onePiece = new MangaModel
                {
                    ...
                    AllLanguages = new List<Languages>
                    {
                        new Languages { LanguageName = "English", OfficalWebSiteToBuy ="https://www.amazon.com/One-Piece-Vol-Romance-Dawn/dp/1569319014/ref=sr_1_3?keywords=Manga+One+Piece&qid=1675256565&sr=8-3" },
                        new Languages { LanguageName = "Japanese", OfficalWebSiteToBuy = "https://www.amazon.com/One-Piece-Vol-1-Japanese/dp/4088725093" },
                        new Languages { LanguageName = "French", OfficalWebSiteToBuy = "https://www.amazon.com/One-Piece-French-Eiichiro-Oda/dp/2344027580" },
                    },

                    OfficalWebsites = new List<OfficalWebsite>
                    {
                        new OfficalWebsite { OfficalWebsiteString = "www.onepiece.com" , WebsiteName = "onepiece.com"  },
                        new OfficalWebsite { OfficalWebsiteString = "onepiece.jp" ,  WebsiteName = "onepiece.jp"},
                    },
                    Authormodels = new List<AuthorModel>
                    {
...
new Languages { LanguageName = "German" },
                    ...
                    OfficalWebsites = new List<OfficalWebsite>
{
new OfficalWebsite { OfficalWebsiteString = "www.AttackOnTitan.com", WebsiteName = "AttackOnTitan.Com" },
new OfficalWebsite { OfficalWebsiteString = "AttackOnTitan.jp", WebsiteName = "AttackOnTitan.jp" },
},
                    Authormodels = new List<AuthorModel>
{
...
new Character { CharacterName = "Mikasa Ackerman" },
            ...
            new AssociatedNames { nameString = "Pretty Soldier Sailor Moon" },
                    ...
                    AllLanguages = new List<Languages>
          {
                        new Languages { LanguageName = "English", OfficalWebSiteToBuy = "https://www.amazon.com/Sailor-Moon-Kodansha-Comics-Edition/dp/1632366419" },
                        new Languages { LanguageName = "Japanese", OfficalWebSiteToBuy = "https://www.amazon.co.jp/SAILOR-MOON-SAILOR-MOON/dp/4088725093" },
                        new Languages { LanguageName = "French", OfficalWebSiteToBuy = "https://www.amazon.fr/Sailor-Moon-Vol-1/dp/2723476573" },
            },

                    OfficalWebsites = new List<OfficalWebsite>
            {
            new OfficalWebsite { OfficalWebsiteString = "www.sailormoon.com", WebsiteName = "SailorMoon.Com"},
            new OfficalWebsite { OfficalWebsiteString = "sailormoon.jp", WebsiteName = "SailorMoon.jp" },
            },
                    Authormodels = new List<AuthorModel>
            {
...
new Languages { LanguageName = "German" },
                    ...
                    OfficalWebsites = new List<OfficalWebsite>
            {
            new OfficalWebsite { OfficalWebsiteString = "www.detectiveConan.com", WebsiteName = "DetectiveConan.Com"},
            new OfficalWebsite { OfficalWebsiteString = "detectiveConan.jp", WebsiteName = "DetectiveConan.jp" },
            },
                    Authormodels = new List<AuthorModel>
            {
